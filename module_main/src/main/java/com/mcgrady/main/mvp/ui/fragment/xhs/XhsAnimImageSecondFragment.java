 ...
 * 第二页动画
 */
public class XhsAnimImageSecondFragment extends XhsBaseAnimImageFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.main_fragment_xhs_anim_image_second, null);
        ...
        Bitmap bmpScroll = BitmapFactory.decodeResource(getResources(), R.mipmap.main_ic_xhs_second_scrollbg);
        Bitmap bmpShield = BitmapFactory.decodeResource(getResources(), R.mipmap.main_ic_xhs_shield);
        Bitmap bmpGoods = BitmapFactory.decodeResource(getResources(), R.mipmap.main_ic_xhs_second_goods);
        ...
        bmpBuysIng = bitmapScale(BitmapFactory.decodeResource(getResources(), R.mipmap.main_ic_xhs_second_buging));
        bmpBuysed = bitmapScale(BitmapFactory.decodeResource(getResources(), R.mipmap.main_ic_xhs_second_bugged));

        RelativeLayout.LayoutParams params = (RelativeLayout.LayoutParams) iv_buy.getLayoutParams();
        int ivBuyMargin = ConvertUtils.dp2px(50);
...
//                            float buyY = ViewHelper.getY(iv_buy);
                            ...
                            float goodsX = iv_goods.getX();
                            float goodsY = iv_goods.getY();
                            float buyX = iv_buy.getX();
                            float buyY = iv_buy.getY();
