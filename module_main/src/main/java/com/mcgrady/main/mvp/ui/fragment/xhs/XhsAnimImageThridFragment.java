 ...
 * 第三页动画
 */
public class XhsAnimImageThridFragment extends XhsBaseAnimImageFragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ViewGroup view = (ViewGroup) inflater.inflate(R.layout.main_fragment_xhs_anim_image_thrid, null);
        ...
        Bitmap bmpScroll= BitmapFactory.decodeResource(getResources(), R.mipmap.main_ic_xhs_thrid_scrollbg);
        Bitmap bmpShield= BitmapFactory.decodeResource(getResources(), R.mipmap.main_ic_xhs_thrid_shield);
        ...
        Bitmap bmpCare= bitmapScale(BitmapFactory.decodeResource(getResources(), R.mipmap.main_ic_xhs_thrid_shield_care));
