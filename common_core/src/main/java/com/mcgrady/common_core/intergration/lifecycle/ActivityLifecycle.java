 ...
 */
package com.mcgrady.common_core.intergration.lifecycle;
...
public class ActivityLifecycle implements Application.ActivityLifecycleCallbacks {
     ...
     * 设置是否使用监听,如果这个 Activity 返回 false 的话,这个 Activity 下面的所有 Fragment 将不能使用 {@link com.mcgrady.common_core.base.delegate.FragmentDelegate}
     * 意味着 {@link com.mcgrady.common_core.base.BaseFragment} 也不能使用
     *
     * @param activity
     */
