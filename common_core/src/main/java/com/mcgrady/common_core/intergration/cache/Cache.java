 ...
 */
package com.mcgrady.common_core.intergration.cache;
...
/**
 * ================================================
 * 用于缓存框架中所必需的组件,开发者可通过 {@link com.mcgrady.common_core.di.module.GlobalConfigModule.Builder#cacheFactory} 为框架提供缓存策略
 * 开发者也可以用于自己日常中的使用
 *
 * @see com.mcgrady.common_core.di.module.GlobalConfigModule#provideCacheFactory(Application)
 * @see LruCache
