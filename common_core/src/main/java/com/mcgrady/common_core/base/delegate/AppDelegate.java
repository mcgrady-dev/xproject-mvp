...
import com.mcgrady.common_core.intergration.ManifestParser;
 ...
 *
 * @see {@link com.mcgrady.common_core.base.BaseApplication}
...
public class AppDelegate implements IApp, AppLifecycles {
     ...
     *
     * @return AppComponent
     * @see com.mcgrady.common_core.utils.Utils#obtainAppComponentFromContext(Context) 可直接获取 {@link AppComponent}
     */
    @NonNull
    @Override
