...
//        Single<List<GithubRepo>> getReposSingle(@Path("id") String userId);
    ...
    static class GithubRepo {
        ...
        public static class OwnerBean {
             ...
             * login : mcgrady911
             * id : 7246012
             * node_id : MDQ6VXNlcjcyNDYwMTI=
             * avatar_url : https://avatars3.githubusercontent.com/u/7246012?v=4
             * gravatar_id :
             * url : https://api.github.com/users/mcgrady911
             * html_url : https://github.com/mcgrady911
             * followers_url : https://api.github.com/users/mcgrady911/followers
             * following_url : https://api.github.com/users/mcgrady911/following{/other_user}
             * gists_url : https://api.github.com/users/mcgrady911/gists{/gist_id}
             * starred_url : https://api.github.com/users/mcgrady911/starred{/owner}{/repo}
             * subscriptions_url : https://api.github.com/users/mcgrady911/subscriptions
             * organizations_url : https://api.github.com/users/mcgrady911/orgs
             * repos_url : https://api.github.com/users/mcgrady911/repos
             * events_url : https://api.github.com/users/mcgrady911/events{/privacy}
             * received_events_url : https://api.github.com/users/mcgrady911/received_events
             * type : User
             * site_admin : false
             */
