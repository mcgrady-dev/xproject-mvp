...
public class GlobalRefreshFooter extends InternalAbstract implements RefreshFooter {
...
//    protected SpinnerStyle mSpinnerStyle = SpinnerStyle.Translate;
    ...
    public GlobalRefreshFooter(@NonNull Context context) {
        this(context, null);
    }

    public GlobalRefreshFooter(@NonNull Context context, @Nullable AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public GlobalRefreshFooter(@NonNull Context context, @Nullable AttributeSet attrs, @AttrRes int defStyleAttr) {
...
//    }
    ...
    public GlobalRefreshFooter setSpinnerStyle(SpinnerStyle mSpinnerStyle) {
        this.mSpinnerStyle = mSpinnerStyle;
        return this;
    }

    public GlobalRefreshFooter setNormalColor(@ColorInt int color) {
        mNormalColor = color;
    ...
    public GlobalRefreshFooter setAnimatingColor(@ColorInt int color) {
