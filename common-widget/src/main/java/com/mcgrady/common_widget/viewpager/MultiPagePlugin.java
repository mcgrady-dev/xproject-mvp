 ...
 * 快速实现一屏多页功能，原理是使用ViewPager的padding+clipPadding=false来使用，所以外部不需要再调用修改padding属性的方法
 */
public class MultiPagePlugin {
    ...
    private MultiPagePlugin(ViewPager viewPager, float pageHeightWidthRatio,
    ...
    public static class Builder {
         ...
         * 构建实例
         *
         * @return MultiPagePlugin
         */
        public MultiPagePlugin build() {
            return new MultiPagePlugin(mViewPager, mPageHeightWidthRatio, mPageHorizontalMinMargin, mPageVerticalMinMargin);
        }
    }
}
