...
public abstract class BasePageTransformer implements ViewPager.PageTransformer {
    ...
    private static final String TAG = BasePageTransformer.class.getSimpleName();

    // 拓展的PagerAdapter
    private BasePagerAdapter mPagerAdapter;

    public BasePageTransformer(@NonNull BasePagerAdapter pagerAdapter) {
    ...
    public void transformPage(@NonNull View page, float position) {
        ...
        if (requirePagePosition) {
            ...
            Log.d(TAG, "transformPage() requirePagePosition: currentItem = ["
