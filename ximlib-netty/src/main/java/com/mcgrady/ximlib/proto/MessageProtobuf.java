...
package com.mcgrady.ximlib.proto;
    ...
    public static final class Msg extends
        ...
        public void writeTo(CodedOutputStream output)
            ...
            if (!getBodyBytes().isEmpty()) {
                GeneratedMessageV3.writeString(output, 2, body_);
            }
        ...
        public int getSerializedSize() {
            ...
            if (!getBodyBytes().isEmpty()) {
                size += GeneratedMessageV3.computeStringSize(2, body_);
            }
        ...
        public static final class Builder extends
            ...
            getHeadFieldBuilder() {
                if (headBuilder_ == null) {
                    headBuilder_ = new SingleFieldBuilderV3<
                            Head, Head.Builder, HeadOrBuilder>(
                            getHead(),
        ...
        private static final Parser<Msg>
                PARSER = new AbstractParser<Msg>() {
    ...
    public static final class Head extends
        ...
        public void writeTo(CodedOutputStream output)
            ...
            if (!getMsgIdBytes().isEmpty()) {
                GeneratedMessageV3.writeString(output, 1, msgId_);
            }
            if (msgType_ != 0) {
            ...
            if (!getFromIdBytes().isEmpty()) {
                GeneratedMessageV3.writeString(output, 4, fromId_);
            }
            if (!getToIdBytes().isEmpty()) {
                GeneratedMessageV3.writeString(output, 5, toId_);
            }
            if (timestamp_ != 0L) {
            ...
            if (!getExtendBytes().isEmpty()) {
                GeneratedMessageV3.writeString(output, 8, extend_);
            }
            unknownFields.writeTo(output);
        }
        ...
        public int getSerializedSize() {
            ...
            size = 0;
            if (!getMsgIdBytes().isEmpty()) {
                size += GeneratedMessageV3.computeStringSize(1, msgId_);
            }
            if (msgType_ != 0) {
                size += CodedOutputStream
            ...
            if (!getFromIdBytes().isEmpty()) {
                size += GeneratedMessageV3.computeStringSize(4, fromId_);
            }
            if (!getToIdBytes().isEmpty()) {
                size += GeneratedMessageV3.computeStringSize(5, toId_);
            }
            if (timestamp_ != 0L) {
                size += CodedOutputStream
            ...
            if (!getExtendBytes().isEmpty()) {
                size += GeneratedMessageV3.computeStringSize(8, extend_);
            }
            size += unknownFields.getSerializedSize();
            memoizedSize = size;
            return size;
        ...
        private static final Parser<Head>
                PARSER = new AbstractParser<Head>() {
