package com.mcgrady.common_core.imageEngine.config;

import android.widget.ImageView;

import com.bumptech.glide.load.resource.bitmap.BitmapTransformation;
import com.mcgrady.xskeleton.http.imageloader.BaseImageLoaderStrategy;
import com.mcgrady.xskeleton.http.imageloader.ImageConfig;
...
public class CommonImageConfigImpl extends ImageConfig {
    ...
    public static final class Builder {
         ...
         * <p>
         * 因为 BitmapTransformation 是 Glide 独有的类, 所以如果 BitmapTransformation 出现在 {@link CommonImageConfigImpl} 中
         * 会使 {@link ImageLoader} 难以切换为其他图片加载框架, 在 {@link CommonImageConfigImpl} 中只能配置基础类型和 Android 包里的类
